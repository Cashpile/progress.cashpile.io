  ...
  return (
    <div className='response'>
      ...
      <p>
        ...
        We've never handled real money before. It's going to be hard, but we'll
        get it done. We were born to do this; it's us or nobody.
      </p>
      <div style={{ height: '7.5vh' }}></div>
      <h2>By Tuesday, people will be able to...</h2>
      <div style={{ height: '2.5vh' }}></div>
      <p>
        ...either explore the app through Prototyping in Adobe XD, or try out a
        basic version of the app through TestFlight.
      </p>
      <div style={{ height: '7.5vh' }}></div>
      ...
      <div className='twitter'>
        ...
        <blockquote className='twitter-tweet'>
          <p lang='en' dir='ltr'>
            ...
            major retailers? What would be the incentive for sellers to migrate
            to KindShop?
          </p>
          &mdash; Joonbeom (Daniel) Kwon (@djbkwon){' '}
        ...
        <blockquote className='twitter-tweet'>
          <p lang='en' dir='ltr'>
            ...
            platform for you to fetch data? If so, that feels like a bottleneck
            to me.
          </p>
          &mdash; Joonbeom (Daniel) Kwon (@djbkwon){' '}
        ...
        <blockquote className='twitter-tweet'>
          <p lang='en' dir='ltr'>
            1. How many people are willing to leave everything behind? 2. Would
            you consider language barriers?
          </p>
          &mdash; Joonbeom (Daniel) Kwon (@djbkwon){' '}
